...
type AsApplication struct {
	...
	FileUrl     string      `orm:"file_url" json:"fileUrl"`        // 文件
	Name        string      `orm:"name" json:"name"`               // 应用名称
	BundleId    string      `orm:"bundle_id" json:"bundleId"`      // 包名
	Version     string      `orm:"version" json:"version"`         // 版本号
	Size        string      `orm:"size" json:"size"`               // 文件大小
	Type        int         `orm:"type" json:"type"`               // 类型
	Description string      `orm:"description" json:"description"` // 描述
	IconUrl     string      `orm:"icon_url" json:"iconUrl"`        // 图标
	Lock        int         `orm:"lock" json:"lock"`               // 付费
	Lanzou      int         `orm:"lanzou" json:"lanzou"`           // 是否蓝奏云链接
	Weigh       int         `orm:"weigh" json:"weigh"`             // 权重
	Active      int         `orm:"active" json:"active"`           // 是否启用
