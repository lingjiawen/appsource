...
// 生成路径: internal/app/appsource/model/sys_config.go
// 生成人：smithy
// desc:配置项
// company:云南奇讯科技有限公司
// ==========================================================================
...
type SysConfigListRes struct {
	...
	LinkedGroup *LinkedSysConfigSysConfigGroup `orm:"with:group_key=group" json:"linkedGroup" dc:"参数分组"`
	Remark      string                         `json:"remark" dc:"备注"`
	CreatedAt   *gtime.Time                    `json:"createdAt" dc:"创建时间"`
}

type SysConfigGroupMapRes struct {
	List map[string][]SysConfigListRes `json:"list"`
}
...
type SysConfigSearchRes struct {
	SysConfigGroupMapRes
	Groups g.Map `json:"groups"`
}
...
type ParseAppInfoReq struct {
	AppPath string `p:"appPath"  dc:"app地址"`
}
